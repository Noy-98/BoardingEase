...
class ChatLandlordDashboard : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_chat_landlord_dashboard)
        ...
        val chat_bttn = findViewById<ImageView>(R.id.add_chat_bttn)

        chat_bttn.setOnClickListener {
            val intent = Intent(this, SendChatLandlordDashboard::class.java)
            startActivity(intent)
        }
    }
}