...
class BoardingAdapter(private val context: Context, private var boardingList: List<BoardingDataStructureDB>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(context).inflate(R.layout.landlord_home_item, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.viewDetailsBttn.setOnClickListener {
            ...
            val intent = Intent(context, LandlordViewDetailsDashboard::class.java)
            intent.putExtra("b_id", boarding.b_id)
