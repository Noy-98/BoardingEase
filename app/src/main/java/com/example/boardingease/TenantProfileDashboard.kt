...
class TenantProfileDashboard : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_tenant_profile_dashboard)
        ...
        if (currentUser != null){
            ...
            usersReference.addValueEventListener(object : ValueEventListener {
                ...
                override fun onCancelled(error: DatabaseError) {
                    Toast.makeText(this@TenantProfileDashboard, "Failed to load profile", Toast.LENGTH_SHORT).show()
                }
